...
import idoelad.finalproject.tremortouch.display.R;
import idoelad.finalproject.tremortouch.display.Consts;
import idoelad.finalproject.tremortouch.display.TestActivity;
...
public class FileChooser extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		currentDir = new File(Consts.mainResultsDir);
		fill(currentDir);		
	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (o.isFolder() || o.isParent()) {			
    		...
    		//Dir path
    		String dir = fileSelected.getParent();
    		...
    		startTestActivityIntent.putExtra("fileSelected", fileSelected.getAbsolutePath());
    		startTestActivityIntent.putExtra("circlesFilePath", circlesFilePath);
